...
public class HealthController : ControllerBase
{
    ...
    public async Task<ActionResult<HealthResponse>> GetHealth()
    {
        try
        {
            ...
            var response = new HealthResponse
            {
                ...
                Checks = healthReport.Entries.ToDictionary(
                    kvp => kvp.Key,
                    kvp => new Models.HealthCheckResult
                    {
        ...
        catch (Exception ex)
        {
            ...
            {
                Status = "Unhealthy",
                Checks = new Dictionary<string, Models.HealthCheckResult>
                {
                    ["system"] = new Models.HealthCheckResult
                    {
                        Status = "Unhealthy",
    ...
    private static DateTime GetBuildTime(Assembly assembly)
    {
        try
        {
            ...
            return System.IO.File.GetCreationTimeUtc(assembly.Location);
        }
        catch
        {
